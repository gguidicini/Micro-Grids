...
def Model_Resolution(model,Optimization_Goal, Renewable_Penetration, Battery_Independency,datapath="Inputs/data_MY.dat"):   
    ...
    Investment_Cost, Operation_Maintenance_Cost_Act, Operation_Maintenance_Cost_NonAct, Battery_Reposition_Cost_Act, Battery_Reposition_Cost_NonAct, Maximun_Generator_Energy, Total_Fuel_Cost_Act, Total_Fuel_Cost_NonAct,\
    Battery_Min_Capacity, Battery_Min_Step_Capacity, Renewables_Min_Step_Units, Generator_Min_Step_Capacity,\
    Investment_Cost_Limit, Scenario_Variable_Cost_Act, Scenario_Variable_Cost_NonAct, Total_Variable_Cost_Act, Total_Variable_Cost_Obj, Net_Present_Cost, Net_Present_Cost_Obj
    ...
    model.BatteryRepositionCostAct = Constraint(model.scenarios,rule=Battery_Reposition_Cost_Act) 
    ...
    if Optimization_Goal == 'Operation cost':
        ...
        model.BatteryRepositionCostNonAct = Constraint(model.scenarios,rule=Battery_Reposition_Cost_NonAct) 
