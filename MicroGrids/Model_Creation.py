...
def Model_Creation(model,Optimization_Goal, Renewable_Penetration,Battery_Independency):
    ...
    from Initialize import Initialize_Demand, Unitary_Battery_Reposition_Cost, Initialize_Renewable_Energy, Generator_Marginal_Cost, Min_Bat_Capacity, Initialize_YearUpgrade_Tuples, Initialize_Upgrades_Number # Import library with initialitation funtions for the parameters
    ...
    model.renewable_sources = RangeSet(1, model.Renewable_Sources)
    model.generator_types = RangeSet(1, model.Generator_Types)    
    ...
    model.Fuel_Cost = Param(model.generator_types,
    ...
    model.Scenario_Lost_Load_Cost = Var(model.scenarios, within=NonNegativeReals)    
